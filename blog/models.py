...
class Comment(models.Model):
    ...
    blog = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='blog_comment', null=True)
    def __str__(self):
        return self.content

class Like(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='like_user', null=True)
    blog = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='blog_like', null=True)
    def __str__(self):
